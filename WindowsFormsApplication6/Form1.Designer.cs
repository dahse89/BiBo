...
namespace BiBo
{
    partial class Form1
    {
        ...
        private Label labelBookAddBookId            = new Label();
        ...
        private TextBox textBoxBookAddBookId         = new TextBox();
        ...
        private void InitializeComponent(int w, int h)
        {
            ...
            //Book Add Labels
            this.labelBookAddBookId.Location        = new Point(10,20);
            this.labelBookAddauthor.Location        = new Point(10,50);
            this.lableBookAddTitel.Location         = new Point(10,80);
            this.labelBookAddsubjectArea.Location   = new Point(10, 110);

            this.labelBookAddBookId.Text        = "Buch id:";
            this.labelBookAddauthor.Text        = "Author:";
            this.lableBookAddTitel.Text         = "Title";
            this.labelBookAddsubjectArea.Text   = "Genre:";

            //Book Add TextBoxes;
            this.textBoxBookAddBookId.Location      = new Point(60, 20);
            this.textBoxBookAddauthor.Location      = new Point(60, 50);
            this.textBoxBookAddTitel.Location       = new Point(60, 80);
            this.textBoxBookAddsubjectArea.Location = new Point(60, 110);

            this.textBoxBookAddBookId.Size = new Size(200, 20);
            this.textBoxBookAddauthor.Size = textBoxBookAddBookId.Size;
            this.textBoxBookAddTitel.Size = textBoxBookAddBookId.Size;
            this.textBoxBookAddsubjectArea.Size = textBoxBookAddBookId.Size;
            ...
            //Adds to groupBoxAddBook
            this.groupBoxAddBook.Controls.Add(this.textBoxBookAddBookId);
            ...
            this.groupBoxAddBook.Controls.Add(this.labelBookAddBookId);
